...
interface Props {
  ...
  canManage: boolean
  onNewAttachment: (a: ProjectAttachmentDTO) => void
...
function isImage(attachment: ProjectAttachmentDTO): boolean {
  return (
...
export default function ProjectAttachments({
  ...
  async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setUploading(true)
    try {
      const { data } = await projectService.uploadAttachment(projectId, file)
