    ...
    <div className="chat-card-enter flex items-start gap-4">
      ...
      <div className="grid max-w-3xl flex-1 grid-cols-1 gap-3 md:grid-cols-2">
        <button
          ...
          className="rounded-[22px] border border-accent-indigo/18 bg-[linear-gradient(180deg,rgba(22,24,40,0.96),rgba(16,18,29,0.96))] p-5 text-left transition-[border-color,transform] duration-150 hover:-translate-y-0.5 hover:border-accent-indigo/34"
        >
